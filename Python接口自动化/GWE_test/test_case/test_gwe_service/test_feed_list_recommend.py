import sys
sys.path.append("E:\chase_Learning\chase_learning\Python接口自动化\GWE_test")

from gwe_service.api.service.FeedListRecommend import FeedListRecommend
...
@case_model()
def test_feed_list_recommend(coupon_id, msg=None, code=200):
    log.step(msg)
    api_obj = FeedListRecommend(coupon_id=coupon_id, status=code)
    return api_obj

...
from order_service.api.controller.OmsOrderReturnReasonController.ReturnReasonIdObj import ReturnReasonIdObj as TemplateController
from common.func import *

class ReturnReasonId(TemplateController):
    """获取单个退货原因详情信息"""

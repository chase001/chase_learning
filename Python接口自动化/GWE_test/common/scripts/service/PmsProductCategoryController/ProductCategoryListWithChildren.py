...
from order_service.api.controller.PmsProductCategoryController.ProductCategoryListWithChildrenObj import ProductCategoryListWithChildrenObj as TemplateController

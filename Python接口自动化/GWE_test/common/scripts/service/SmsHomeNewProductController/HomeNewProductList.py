...
from order_service.api.controller.SmsHomeNewProductController.HomeNewProductListObj import HomeNewProductListObj as TemplateController
from common.func import *

class HomeNewProductList(TemplateController):
    """分页查询推荐"""

...
from order_service.api.controller.PmsProductAttributeController.ProductAttributeUpdateIdObj import ProductAttributeUpdateIdObj as TemplateController
from common.func import *

class ProductAttributeUpdateId(TemplateController):
    """修改商品属性信息"""

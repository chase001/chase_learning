...
from order_service.api.controller.SmsHomeRecommendSubjectController.HomeRecommendSubjectCreateObj import HomeRecommendSubjectCreateObj as TemplateController
from common.func import *

class HomeRecommendSubjectCreate(TemplateController):
    """添加首页推荐专题"""

...
from order_service.api.controller.UmsAdminController.AdminUpdatePasswordObj import AdminUpdatePasswordObj as TemplateController
from common.func import *

class AdminUpdatePassword(TemplateController):
    """修改指定用户密码"""

...
from order_service.api.controller.UmsAdminController.AdminDeleteIdObj import AdminDeleteIdObj as TemplateController
from common.func import *

class AdminDeleteId(TemplateController):
    """删除指定用户信息"""

...
from order_service.api.controller.UmsAdminController.AdminTokenRefreshObj import AdminTokenRefreshObj as TemplateController
from common.func import *

class AdminTokenRefresh(TemplateController):
    """刷新token"""

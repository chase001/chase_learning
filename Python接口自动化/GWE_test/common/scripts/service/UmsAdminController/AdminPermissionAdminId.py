...
from order_service.api.controller.UmsAdminController.AdminPermissionAdminIdObj import AdminPermissionAdminIdObj as TemplateController
from common.func import *

class AdminPermissionAdminId(TemplateController):
    """获取用户所有权限（包括+-权限）"""

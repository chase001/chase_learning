...
from order_service.api.controller.OmsOrderController.OrderUpdateMoneyInfoObj import OrderUpdateMoneyInfoObj as TemplateController
from common.func import *

class OrderUpdateMoneyInfo(TemplateController):
    """修改订单费用信息"""

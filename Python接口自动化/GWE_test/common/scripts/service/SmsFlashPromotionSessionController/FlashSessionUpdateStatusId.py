...
from order_service.api.controller.SmsFlashPromotionSessionController.FlashSessionUpdateStatusIdObj import FlashSessionUpdateStatusIdObj as TemplateController
from common.func import *

class FlashSessionUpdateStatusId(TemplateController):
    """修改启用状态"""

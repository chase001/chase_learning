...
from order_service.api.controller.SmsFlashPromotionSessionController.FlashSessionCreateObj import FlashSessionCreateObj as TemplateController
from common.func import *

class FlashSessionCreate(TemplateController):
    """添加场次"""

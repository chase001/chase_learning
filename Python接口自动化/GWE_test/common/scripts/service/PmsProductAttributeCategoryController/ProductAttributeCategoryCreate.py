...
from order_service.api.controller.PmsProductAttributeCategoryController.ProductAttributeCategoryCreateObj import ProductAttributeCategoryCreateObj as TemplateController

...
from order_service.api.controller.SmsHomeBrandController.HomeBrandUpdateRecommendStatusObj import HomeBrandUpdateRecommendStatusObj as TemplateController

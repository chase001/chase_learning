...
from order_service.api.controller.SmsHomeBrandController.HomeBrandCreateObj import HomeBrandCreateObj as TemplateController
from common.func import *

class HomeBrandCreate(TemplateController):
    """添加首页推荐品牌"""

...
from order_service.api.controller.OmsOrderReturnApplyController.ReturnApplyUpdateStatusIdObj import ReturnApplyUpdateStatusIdObj as TemplateController
from common.func import *

class ReturnApplyUpdateStatusId(TemplateController):
    """修改申请状态"""

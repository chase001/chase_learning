...
from order_service.api.controller.PmsProductController.ProductUpdateIdObj import ProductUpdateIdObj as TemplateController
from common.func import *

class ProductUpdateId(TemplateController):
    """更新商品"""

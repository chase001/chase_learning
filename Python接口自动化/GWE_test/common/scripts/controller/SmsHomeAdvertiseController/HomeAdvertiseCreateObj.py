...
class HomeAdvertiseCreateObj(BaseOrder):
    """api controller obj"""
    def __init__(self, **kwargs):
        super(HomeAdvertiseCreateObj, self).__init__()
        self.info = "添加广告"
        self.uri = "/home/advertise/create"
        self.method = "post"
    ...
    class Resp(object):
        def __init__(self):
            super(HomeAdvertiseCreateObj.Resp, self).__init__()
            self.code = None  # None
            self.data = None  # None

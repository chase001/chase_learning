...
class ProductCategoryListWithChildrenObj(BaseOrder):
    """api controller obj"""
    def __init__(self, **kwargs):
        super(ProductCategoryListWithChildrenObj, self).__init__()
    ...
    class Resp(object):
        def __init__(self):
            super(ProductCategoryListWithChildrenObj.Resp, self).__init__()
            self.code = None  # None
            self.data = [self.PmsProductCategoryWithChildrenItem()]  # None
            self.message = None  # None
            
        class PmsProductCategoryWithChildrenItem(object):
            """None"""
            def __init__(self):
                self.children = [self.PmsProductCategory()]  # None

...
from Gwe_service.api.controller.PmsProductCategoryController.ProductCategoryListParentIdObj import ProductCategoryListParentIdObj as TemplateController

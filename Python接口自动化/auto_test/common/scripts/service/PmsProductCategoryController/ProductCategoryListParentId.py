...
from order_service.api.controller.PmsProductCategoryController.ProductCategoryListParentIdObj import ProductCategoryListParentIdObj as TemplateController
from common.func import *

class ProductCategoryListParentId(TemplateController):
    """分页查询商品分类"""

...
from order_service.api.controller.PmsProductCategoryController.ProductCategoryIdObj import ProductCategoryIdObj as TemplateController
from common.func import *

class ProductCategoryId(TemplateController):
    """根据id获取商品分类"""

...
from order_service.api.controller.SmsHomeAdvertiseController.HomeAdvertiseIdObj import HomeAdvertiseIdObj as TemplateController
from common.func import *

class HomeAdvertiseId(TemplateController):
    """获取广告详情"""

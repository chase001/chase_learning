...
from Gwe_service.api.controller.SmsFlashPromotionSessionController.FlashSessionUpdateStatusIdObj import FlashSessionUpdateStatusIdObj as TemplateController

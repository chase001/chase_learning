...
from order_service.api.controller.SmsFlashPromotionSessionController.FlashSessionIdObj import FlashSessionIdObj as TemplateController
from common.func import *

class FlashSessionId(TemplateController):
    """获取场次详情"""

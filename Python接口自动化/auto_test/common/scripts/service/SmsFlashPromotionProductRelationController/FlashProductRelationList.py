...
from Gwe_service.api.controller.SmsFlashPromotionProductRelationController.FlashProductRelationListObj import FlashProductRelationListObj as TemplateController

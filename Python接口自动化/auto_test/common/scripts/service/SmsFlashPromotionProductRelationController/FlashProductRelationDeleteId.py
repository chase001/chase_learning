...
from order_service.api.controller.SmsFlashPromotionProductRelationController.FlashProductRelationDeleteIdObj import FlashProductRelationDeleteIdObj as TemplateController

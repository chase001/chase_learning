...
from order_service.api.controller.UmsRoleController.RolePermissionRoleIdObj import RolePermissionRoleIdObj as TemplateController
from common.func import *

class RolePermissionRoleId(TemplateController):
    """获取相应角色权限"""

...
from order_service.api.controller.PmsBrandController.BrandUpdateFactoryStatusObj import BrandUpdateFactoryStatusObj as TemplateController
from common.func import *

class BrandUpdateFactoryStatus(TemplateController):
    """批量更新厂家制造商状态"""

...
from order_service.api.controller.PmsProductController.ProductUpdateInfoIdObj import ProductUpdateInfoIdObj as TemplateController
from common.func import *

class ProductUpdateInfoId(TemplateController):
    """根据商品id获取商品编辑信息"""

...
from order_service.api.controller.PmsProductController.ProductSimpleListObj import ProductSimpleListObj as TemplateController
from common.func import *

class ProductSimpleList(TemplateController):
    """根据商品名称或货号模糊查询"""

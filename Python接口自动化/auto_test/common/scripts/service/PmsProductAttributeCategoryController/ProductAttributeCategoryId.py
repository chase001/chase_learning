...
from Gwe_service.api.controller.PmsProductAttributeCategoryController.ProductAttributeCategoryIdObj import ProductAttributeCategoryIdObj as TemplateController

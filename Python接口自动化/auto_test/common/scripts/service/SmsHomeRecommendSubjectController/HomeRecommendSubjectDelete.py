...
from Gwe_service.api.controller.SmsHomeRecommendSubjectController.HomeRecommendSubjectDeleteObj import HomeRecommendSubjectDeleteObj as TemplateController

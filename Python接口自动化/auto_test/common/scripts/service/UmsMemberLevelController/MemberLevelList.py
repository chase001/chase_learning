...
from order_service.api.controller.UmsMemberLevelController.MemberLevelListObj import MemberLevelListObj as TemplateController
from common.func import *

class MemberLevelList(TemplateController):
    """查询所有会员等级"""

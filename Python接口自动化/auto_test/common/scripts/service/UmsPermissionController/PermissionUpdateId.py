...
from order_service.api.controller.UmsPermissionController.PermissionUpdateIdObj import PermissionUpdateIdObj as TemplateController
from common.func import *

class PermissionUpdateId(TemplateController):
    """修改权限"""

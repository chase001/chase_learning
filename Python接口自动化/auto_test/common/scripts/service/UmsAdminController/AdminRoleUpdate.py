...
from order_service.api.controller.UmsAdminController.AdminRoleUpdateObj import AdminRoleUpdateObj as TemplateController
from common.func import *

class AdminRoleUpdate(TemplateController):
    """给用户分配角色"""

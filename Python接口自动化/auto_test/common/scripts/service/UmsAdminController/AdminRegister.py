...
from order_service.api.controller.UmsAdminController.AdminRegisterObj import AdminRegisterObj as TemplateController
from common.func import *

class AdminRegister(TemplateController):
    """用户注册"""

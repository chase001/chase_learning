...
from order_service.api.controller.PmsSkuStockController.SkuUpdatePidObj import SkuUpdatePidObj as TemplateController
from common.func import *

class SkuUpdatePid(TemplateController):
    """批量更新库存信息"""

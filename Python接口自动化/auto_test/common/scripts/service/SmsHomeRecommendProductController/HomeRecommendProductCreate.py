...
from order_service.api.controller.SmsHomeRecommendProductController.HomeRecommendProductCreateObj import HomeRecommendProductCreateObj as TemplateController
from common.func import *

class HomeRecommendProductCreate(TemplateController):
    """添加首页推荐"""

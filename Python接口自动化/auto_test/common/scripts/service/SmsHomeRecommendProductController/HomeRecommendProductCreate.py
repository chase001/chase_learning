...
from Gwe_service.api.controller.SmsHomeRecommendProductController.HomeRecommendProductCreateObj import HomeRecommendProductCreateObj as TemplateController

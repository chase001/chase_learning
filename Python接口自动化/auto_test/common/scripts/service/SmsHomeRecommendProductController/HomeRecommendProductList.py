...
from Gwe_service.api.controller.SmsHomeRecommendProductController.HomeRecommendProductListObj import HomeRecommendProductListObj as TemplateController

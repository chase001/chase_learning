...
from order_service.api.controller.SmsHomeRecommendProductController.HomeRecommendProductListObj import HomeRecommendProductListObj as TemplateController
from common.func import *

class HomeRecommendProductList(TemplateController):
    """分页查询推荐"""

...
from Gwe_service.api.controller.SmsHomeRecommendProductController.HomeRecommendProductUpdateSortIdObj import HomeRecommendProductUpdateSortIdObj as TemplateController

...
class ProductUpdateIdObj(BaseOrder):
    """api controller obj"""
    def __init__(self, **kwargs):
        super(ProductUpdateIdObj, self).__init__()
        self.info = "更新商品"
    ...
    class Body(BaseObj):
        ...
        class PmsMemberPrice(object):
            ...
            def __init__(self):
                self.id = None  # None
                self.memberLevelId = None  # None
                self.memberLevelName = None  # None
                self.memberPrice = None  # 会员价格
    ...
    class Resp(object):
        def __init__(self):
            super(ProductUpdateIdObj.Resp, self).__init__()
            self.code = None  # None
            self.data = None  # None
